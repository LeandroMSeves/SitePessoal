 ...
 * Desenvolvido por: Leandro Moreno Seves
 * Data: 30/11/2011
*///
...
$envia =  mail($para,"LMSInfo.com.br",$mensagem,$headers);
  
// Envia um e-mail para o remetente, agradecendo a visita no site, e dizendo que em breve o e-mail será respondido.

$mensagem2  = "<p>Olá <strong>" . $recebenome . "</strong>. Agradeço sua visita e gostaria de informar-lhe que recebermos o seu contato. O mais breve possível, estarei retornando o contato.</p>";
...
echo "<meta http-equiv='refresh' content='2;URL=contatos.html'>";
